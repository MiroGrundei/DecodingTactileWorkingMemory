function D3_1st_level_glm(subj_dir, outputfolder_1st, prefix_func, tr, fmri_t, fmri_t0, runs, condnames, onsets, duration, hm, cc)
...
for r = 1:size(runs,2)
    ...
    if exist(run_dir)==7
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(r).hpf = 192; 
